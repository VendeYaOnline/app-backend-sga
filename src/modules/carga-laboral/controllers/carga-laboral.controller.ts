...
export class CargaLaboralController {
  ...
  @Get('resumen')
  @ApiOperation({ summary: 'Resumen de carga laboral', description: 'Retorna un resumen agrupado de acciones de carga laboral por tipo' })
  ...
  @Get('detalle')
  @ApiOperation({ summary: 'Detalle de carga laboral', description: 'Retorna el detalle paginado de acciones de carga laboral con filtros' })
  ...
  @Get('exportar')
  @ApiOperation({ summary: 'Exportar carga laboral', description: 'Exporta en formato plano los datos de carga laboral según filtros' })
