...
export class PrefacturacionController {
  ...
  @Get('periodos')
  @ApiOperation({ summary: 'Listar periodos de prefacturación', description: 'Retorna lista paginada de periodos de prefacturación' })
  ...
  @Get('periodos/:id')
  @ApiOperation({ summary: 'Ver detalle de un periodo', description: 'Retorna el detalle de un periodo de prefacturación' })
  ...
  @Post('periodos')
  @HttpCode(201)
  @ApiOperation({ summary: 'Crear un nuevo periodo', description: 'Crea un nuevo periodo de prefacturación (año/mes)' })
  ...
  @ApiOperation({ summary: 'Cerrar periodo de prefacturación', description: 'Cierra un periodo de prefacturación, impidiendo nuevas modificaciones' })
  ...
  @ApiOperation({ summary: 'Ver detalles de un periodo', description: 'Retorna los detalles de prefacturación de un periodo' })
  ...
  @ApiOperation({ summary: 'Ver resumen de un periodo', description: 'Retorna el resumen de prefacturación de un periodo (totales, días)' })
  ...
  @Post('detalles')
  @HttpCode(201)
  @ApiOperation({ summary: 'Agregar detalle de prefacturación', description: 'Agrega un nuevo detalle a un periodo de prefacturación' })
