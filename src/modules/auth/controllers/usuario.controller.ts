...
export class UsuarioController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna lista paginada de usuarios del sistema con filtros por búsqueda, rol y estado',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Buscar por nombre, apellido, email o RUT',
  })
  @ApiQuery({
    name: 'activo',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: Number,
    description: 'Filtrar por ID de rol asignado',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Registra un usuario en el sistema con sus datos y credenciales',
  })
  @ApiResponse({ status: 201, description: 'Usuario creado exitosamente' })
  @ApiResponse({
    status: 400,
    description: 'Datos inválidos o email/RUT duplicado',
  })
