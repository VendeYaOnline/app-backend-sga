...
export class CreateSoporteMotivoDto {
  ...
  @ApiPropertyOptional({ description: 'Si es el motivo principal del agendamiento', default: false })
  @IsOptional()
  @IsBoolean()
  esMotivoPrincipal?: boolean;

  @ApiPropertyOptional({ description: 'Observación específica del problema', maxLength: 500 })
  @IsOptional()
  @MaxLength(500)
  observacion?: string;
}
