...
export class EventoController {
  ...
  @Get('eventos')
  @ApiOperation({ summary: 'Listar eventos con filtros', description: 'Retorna lista paginada de eventos con filtros opcionales' })
  ...
  @Get('eventos/:id')
  @ApiOperation({ summary: 'Ver detalle de un evento', description: 'Retorna el detalle completo de un evento por su ID' })
  ...
  @Post('eventos')
  @HttpCode(201)
  @ApiOperation({ summary: 'Crear un nuevo evento (genera validaciones automáticas)', description: 'Crea un evento y genera sus validaciones automáticas según el tipo de evento' })
  ...
  @Put('eventos/:id')
  @ApiOperation({ summary: 'Editar datos generales del evento', description: 'Actualiza los datos generales de un evento existente' })
  ...
  @ApiOperation({ summary: 'Ver validaciones del evento', description: 'Retorna las validaciones asociadas a un evento' })
  ...
  @ApiOperation({ summary: 'Ejecutar validación (aprobar/rechazar)', description: 'Ejecuta una validación específica de un evento' })
  @ApiResponse({ status: 200, description: 'Validación ejecutada exitosamente' })
  @ApiResponse({ status: 404, description: 'Evento o validación no encontrada' })
  @ApiParam({ name: 'id', type: Number, description: 'ID del evento' })
  @ApiParam({ name: 'validacionId', type: Number, description: 'ID de la validación' })
  ...
  @Get('procesos')
  @ApiOperation({ summary: 'Listar procesos en terreno', description: 'Retorna lista paginada de procesos en terreno con filtros opcionales' })
  ...
  @ApiOperation({ summary: 'Editar datos del proceso', description: 'Actualiza los datos de un proceso en terreno' })
  ...
  @ApiOperation({ summary: 'Cerrar proceso (realizado/no realizado)', description: 'Cierra un proceso en terreno indicando su resultado' })
  ...
  @ApiOperation({ summary: 'Agregar detalle de soporte técnico', description: 'Agrega un detalle de soporte técnico a un proceso' })
  @ApiResponse({ status: 201, description: 'Detalle de soporte agregado exitosamente' })
  @ApiResponse({ status: 404, description: 'Proceso no encontrado' })
  @ApiParam({ name: 'eventoId', type: Number, description: 'ID del evento/proceso' })
  ...
  @ApiOperation({ summary: 'Editar datos de resolución judicial', description: 'Actualiza los datos de una resolución judicial asociada a un evento' })
  @ApiResponse({ status: 200, description: 'Resolución actualizada exitosamente' })
  ...
  @ApiOperation({ summary: 'Editar datos de cambio de domicilio', description: 'Actualiza los datos de un cambio de domicilio asociado a una resolución' })
  @ApiResponse({ status: 200, description: 'Cambio de domicilio actualizado exitosamente' })
  @ApiResponse({ status: 404, description: 'Cambio de domicilio no encontrado' })
  @ApiParam({ name: 'eventoId', type: Number, description: 'ID del evento' })
