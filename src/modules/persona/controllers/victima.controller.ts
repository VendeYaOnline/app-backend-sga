...
export class VictimaController {
  ...
  @Get()
  @ApiOperation({ summary: 'Buscar víctimas con filtros', description: 'Retorna lista paginada de víctimas con filtros por búsqueda y RUT' })
  ...
  @ApiQuery({ name: 'rutVictima', required: false, type: String, description: 'Filtrar por RUT de la víctima' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Obtener detalle de una víctima', description: 'Retorna los datos completos de una víctima incluyendo sus contactos' })
  ...
  @Post()
  @HttpCode(201)
  @ApiOperation({ summary: 'Registrar una nueva víctima', description: 'Crea un registro de víctima con sus datos personales y de identificación' })
  ...
  @Put(':id')
  @ApiOperation({ summary: 'Actualizar datos de la víctima', description: 'Modifica los datos personales de una víctima existente' })
  @ApiParam({ name: 'id', description: 'ID de la víctima', type: Number })
  ...
  @Delete(':id')
  @HttpCode(204)
  @ApiOperation({ summary: 'Desactivar víctima (soft delete)', description: 'Marca a la víctima como eliminada sin borrar sus registros asociados' })
  @ApiParam({ name: 'id', description: 'ID de la víctima', type: Number })
  ...
  @Get(':id/contactos')
  @ApiOperation({ summary: 'Listar contactos de la víctima', description: 'Retorna los números de teléfono y contactos asociados a la víctima' })
  @ApiParam({ name: 'id', description: 'ID de la víctima', type: Number })
  ...
  @Post(':id/contactos')
  @HttpCode(201)
  @ApiOperation({ summary: 'Agregar teléfono/contacto a la víctima', description: 'Registra un nuevo número de teléfono o contacto para la víctima' })
  @ApiParam({ name: 'id', description: 'ID de la víctima', type: Number })
  ...
  @HttpCode(204)
  @ApiOperation({ summary: 'Eliminar contacto de la víctima', description: 'Quita un número de teléfono o contacto de la víctima' })
  @ApiParam({ name: 'id', description: 'ID de la víctima', type: Number })
