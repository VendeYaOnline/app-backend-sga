...
export class NotificacionController {
  ...
  @Get()
  @ApiOperation({ summary: 'Listar notificaciones del usuario', description: 'Retorna las notificaciones del usuario autenticado con filtros opcionales' })
  ...
  @Get('no-leidas')
  @ApiOperation({ summary: 'Contar notificaciones no leídas', description: 'Retorna la cantidad de notificaciones no leídas del usuario autenticado' })
  ...
  @Put(':id/leida')
  @ApiOperation({ summary: 'Marcar notificación como leída', description: 'Marca una notificación específica como leída' })
  @ApiResponse({ status: 200, description: 'Notificación marcada como leída' })
  @ApiResponse({ status: 404, description: 'Notificación no encontrada' })
  @ApiParam({ name: 'id', type: Number, description: 'ID de la notificación de usuario' })
  ...
  @Put('leer-todas')
  @HttpCode(200)
  @ApiOperation({ summary: 'Marcar todas las notificaciones como leídas', description: 'Marca todas las notificaciones pendientes del usuario como leídas' })
  ...
  @Get('plantillas')
  @ApiOperation({ summary: 'Listar plantillas de notificación', description: 'Retorna todas las plantillas de notificación disponibles' })
  ...
  @Get('plantillas/:id')
  @ApiOperation({ summary: 'Ver detalle de una plantilla', description: 'Retorna el detalle de una plantilla de notificación por su ID' })
  ...
  @Post('plantillas')
  @HttpCode(201)
  @ApiOperation({ summary: 'Crear una nueva plantilla', description: 'Crea una nueva plantilla de notificación' })
  ...
  @Put('plantillas/:id')
  @ApiOperation({ summary: 'Actualizar una plantilla', description: 'Actualiza los datos de una plantilla de notificación existente' })
