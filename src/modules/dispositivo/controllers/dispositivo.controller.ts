...
export class DispositivoController {
  ...
  @ApiOperation({
    ...
    description: 'Retorna lista paginada de dispositivos con búsqueda opcional',
  })
  ...
  @Get('dispositivos/:id')
  @ApiOperation({
    summary: 'Ver detalle de un dispositivo',
    description: 'Retorna el detalle completo de un dispositivo por su ID',
  })
  ...
  @ApiOperation({
    ...
    description: 'Registra un nuevo dispositivo en el inventario',
  })
  ...
  @ApiOperation({
    summary: 'Listar accesorios de un proceso',
    description: 'Retorna los accesorios asociados a un proceso en terreno',
  })
  ...
  @HttpCode(201)
  @ApiOperation({
    summary: 'Agregar accesorio a un proceso',
    description: 'Asocia un nuevo accesorio a un proceso en terreno',
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'Proceso o dispositivo no encontrado',
  })
  @ApiParam({
    name: 'eventoId',
    type: Number,
